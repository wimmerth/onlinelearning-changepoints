...
def evaluate_method(changepoints: list, annotations: list, metric: metrics.changepoints.base.ChangePointMetric):
    """
    ...
    """
    return metric(changepoints, annotations)
...
def benchmark(
    ...
    changepoints = run_method(method, data)
    results = evaluate_method(annotations, changepoints, metric)
    return results
